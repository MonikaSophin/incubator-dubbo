...
/**
 * Parameter  Parameter 参数注解，用于 Dubbo URL 的 parameters 拼接。
 *  在配置对象的 getting 方法上，我们可以看到该注解的使用
 */
@Documented
...
public @interface Parameter {
     ...
     * 是否为属性
     * 目前用于 事件通知
     * 详见(@link https://dubbo.gitbooks.io/dubbo-user-book/demos/events-notify.html)
     */
     ...
     * </p>
     *
     * 举个例子，如果 `ProviderConfig.filter=aaaFilter` ，`ServiceConfig.filter=bbbFilter` ，
