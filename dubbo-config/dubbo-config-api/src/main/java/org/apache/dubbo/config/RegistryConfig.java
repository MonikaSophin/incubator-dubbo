...
public class RegistryConfig extends AbstractConfig {
    ...
    /**<protocol>
     * 注同中心地址协议，支持dubbo, http, local三种协议，分别表示，dubbo地址，http地址，本地注册中心。default(dubbo)
     *     // protocol for register center
     */
    private String protocol;

    /**registry.transporter
     * 网络传输方式，可选mina,netty	default(netty)
     *     // client impl
     */
     ...
     * 比如用心跳检测的实现，此时间就是心跳间隔，不同注册中心实现不一样。 default(60000)
    ...
    /**dynamic
     * 服务是否动态注册，
     * 如果设为false，注册后将显示后disable状态，需人工启用，并且服务提供者停止时，也不会自动取消注册，需人工禁用。default(true)
    ...
    /**register
     * 是否向此注册中心注册服务，
     * 如果设为false，将只订阅，不注册  default(true)
    ...
    /**subscribe
     * 是否向此注册中心订阅服务，
     * 如果设为false，将只注册，不订阅   default(true)
